...
import { PICBIGSIZE, MENU_TYPE_MENU, OSS_SEPARATOR } from '@/utils/constant'
...
export function getImgDom(src) {
  ...
  return new Promise((resolve) => {
    ...
    img.src = src + `${src.includes('?') ? '&' : '?'}uid=` + createRandomNum()
  })
}
...
export function numberToBoolean(bool) {
  return !!bool
}
